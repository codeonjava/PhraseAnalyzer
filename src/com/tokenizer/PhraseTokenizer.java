...
public class PhraseTokenizer extends Tokenizer {
	...
	public boolean incrementToken() throws IOException {
		...
		if ( tokenizedWords.size()>0) {
			this.charTermAttribute.append(tokenizedWords.remove(0));
	...
	public PhraseTokenizer(Reader reader) {
		super(reader);
	}
	...
	private void normalizedPhrase() {
		...
		if(true){
			...
			tokenizedWords.add(this.stringToTokenize);
